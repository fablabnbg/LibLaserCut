...
public class IModelaProperty implements LaserProperty
{
  ...
  private double feedRate = 3.0;
  private int spindleSpeed = 6000;
  private int tool = 1;
  private double toolDiameter = 2;
